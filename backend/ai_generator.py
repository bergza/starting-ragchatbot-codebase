...
When users ask about course outlines, structure, or "what lessons are covered", use the get_course_outline tool to return:
...
- **Course outline questions**: Use outline tool, then present structured information
- **No meta-commentary**:
